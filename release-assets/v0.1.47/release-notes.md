# v0.1.47 — native Windows migration
...
- `esp32-notifier-v0.1.47.bin`
- `esp32-notifier-hacs-v0.1.47.bin`
- `esp32-notifier-hacs-slim-v0.1.47.bin`
- `esp32-notifier-hacs-legacy-ota-v0.1.47.bin`
- `esp32s3-notifier-v0.1.47.bin`
- `esp32s3-notifier-hacs-v0.1.47.bin`
- `esp32s3-notifier-hacs-slim-v0.1.47.bin`
- `esp32c3-notifier-hacs-v0.1.47.bin`
- `esp32-ota-bridge-v0.1.47.bin`
- `esp32s3-ota-bridge-v0.1.47.bin`
- `esp32c3-ota-bridge-v0.1.47.bin`
- `ELMA-Flasher-v0.1.49.exe`
